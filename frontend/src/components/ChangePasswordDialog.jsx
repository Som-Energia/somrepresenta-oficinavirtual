...
// TODO: Let the user inject the specific function to actually perform the action and thus removing the dependency on ov
...
function ChangePasswordDialog(params) {
  ...
  async function handleSubmit(ev) {
    ...
    beSuccess(false)
    try {
      await ov.localChangePassword(currentPassword, newPassword)
      beLoading(false)
      beSuccess(true)
  ...
  return (
    <>
      <DialogTitle>
        {t("CHANGE_PASSWORD.CHANGE_PASSWORD_DIALOG_TITLE")}
      </DialogTitle>
