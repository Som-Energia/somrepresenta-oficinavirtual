  ...
  return (
    <>
      ...
      <Icon
        ...
        {...{
          "aria-description": format.enumeration(
            paymentStatus,
...
export default function InvoicesPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      numeric: false,
      view: (invoice) => (
        <PaymentStatusCell paymentStatus={invoice.payment_status} />
      ),
    },
  ]
  const actions = []
  ...
  if (error)
    return (
      <Container>
        <PageTitle Icon={DescriptionIconMenu}>
    ...
    <Container>
      ...
      <MultiItemView
        ...
        itemBody={(invoice) => [
          ...
          <span key={"invoicesSpan"} style={{ whiteSpace: "nowrap" }}>
        ...
        noDataPlaceHolder={
          <Typography variant="h4">{t("INVOICES.NO_INVOICES")}</Typography>
        }
      />
    </Container>
  )
